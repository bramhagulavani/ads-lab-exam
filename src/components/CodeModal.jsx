...
function highlightC(code) {
  ...
  return lines.map((line, lineIdx) => {
    ...
    return `
    <span class="line-num">${String(lineIdx + 1).padStart(3, ' ')}</span>${escaped}`
  }).join('\n')
}
    ...
    navigator.clipboard.writeText(question.algorithm)
      .then(() => {
        ...
        if (btn) {
          ...
          setTimeout(() => {
            btn.textContent = 'Copy Algorithm'
            btn.classList.remove(styles.copied)
          }, 2000)
      ...
      <div className={styles.modal}>
        ...
        <div className={styles.modalHeader}>
          ...
          <div className={styles.modalHeaderLeft}>
            ...
            <span className={styles.modalQNum}>
          ...
          {question.algorithm && (
            ...
            <div className={styles.algorithmSection}>
              ...
              <div className={styles.algorithmHeader}>
                ...
                <h3 className={styles.algorithmTitle}>
                  Algorithm
                </h3>
              ...
              <pre className={styles.algorithmText}>
                {question.algorithm}
              </pre>
        ...
        <div className={styles.navigation}>
          ...
          >
            ...
            {
              prevQ
                ? `Q${String(prevQ.id).padStart(2, '0')}`
                : 'First'
            }
          ...
          >
            ...
            {
              nextQ
                ? `Q${String(nextQ.id).padStart(2, '0')}`
                : 'Last'
            }
